...
import com.pin.flake.core.HostAddressIdMeta;
...
public class HostAddressIdGeneratorTest {
    ...
    public void testGenerate() {
        ...
        long clusterId = segments[2], nodeId = segments[3];
